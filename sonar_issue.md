...
4. Issue重複確認: 特定した1件が既にgithub issueとして起票されていないか確認してください。既にある場合は次点で優先すべきものに切り替え、手順3からやり直してください。
5. 全体結果と、最優先で修正すべき指摘1件の詳細を共有し、対応の承認を得てください。
...
6. 指摘対応: 承認を得られたら、github issueを作成してください。
